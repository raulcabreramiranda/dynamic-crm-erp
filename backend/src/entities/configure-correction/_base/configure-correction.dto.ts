...
import { ConfigureCorrectionOptions } from '../../../entities/configure-correction/_base/configure-correction-options.enum';
import { ConfigureCorrectionIa } from '../../../entities/configure-correction/_base/configure-correction-ia.enum';
import { NotesReturnConfigure } from '../../../entities/configure-correction/_base/notes-return-configure.enum';
