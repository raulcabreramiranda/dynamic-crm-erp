...
export class AdminWhiteLabelService {
    ...
    async findById(id: string, selectFields?: string[], selectColumns?: string): Promise<AdminWhiteLabel | undefined> {
        const options: any = {};
    ...
    async findByfields(options: FindOneOptions<AdminWhiteLabel>): Promise<AdminWhiteLabel | undefined> {
        return await this.adminWhiteLabelRepository.findOne(options);
    }

    async findAndCount(
        options: FindManyOptions<AdminWhiteLabel>,
        filters?: Array<{ column: string; value: string; operation: string }>[],
        selectFields?: string[],
        selectColumns?: string,
    ): Promise<[AdminWhiteLabel[], number]> {
    ...
    async save(adminWhiteLabel: AdminWhiteLabel): Promise<AdminWhiteLabel | undefined> {
        const element = await this.adminWhiteLabelRepository.save(adminWhiteLabel);
        return element;
    }

    async update(adminWhiteLabel: AdminWhiteLabel): Promise<AdminWhiteLabel | undefined> {
        const element = await this.adminWhiteLabelRepository.save(adminWhiteLabel);
        return element;
    }

    async delete(adminWhiteLabel: AdminWhiteLabel): Promise<AdminWhiteLabel | undefined> {
        const element = await this.adminWhiteLabelRepository.remove(adminWhiteLabel);
        return element;
    }
}
