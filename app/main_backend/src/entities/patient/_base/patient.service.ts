...
export class PatientService {
    ...
    constructor(@Inject(REQUEST) protected readonly request: Request, @Inject('PATIENT_REPOSITORY') protected patientRepository: Repository<Patient>) {}

    async findById(id: string, selectFields?: string[], selectColumns?: string): Promise<Patient | undefined> {
        const options: any = {};
    ...
    async findByfields(options: FindOneOptions<Patient>): Promise<Patient | undefined> {
    ...
    async save(patient: Patient): Promise<Patient | undefined> {
        const element = await this.patientRepository.save(patient);
        return element;
    }
    ...
    async delete(patient: Patient): Promise<Patient | undefined> {
        const element = await this.patientRepository.remove(patient);
        return element;
    }
}
