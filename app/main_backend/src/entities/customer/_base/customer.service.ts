...
export class CustomerService {
    ...
    constructor(@Inject(REQUEST) protected readonly request: Request, @Inject('CUSTOMER_REPOSITORY') protected customerRepository: Repository<Customer>) {}

    async findById(id: string, selectFields?: string[], selectColumns?: string): Promise<Customer | undefined> {
        const options: any = {};
    ...
    async save(customer: Customer): Promise<Customer | undefined> {
        const element = await this.customerRepository.save(customer);
        return element;
    }
    ...
    async delete(customer: Customer): Promise<Customer | undefined> {
        const element = await this.customerRepository.remove(customer);
        return element;
    }
}
