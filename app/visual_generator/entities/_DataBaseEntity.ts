...
type DataBaseEntityViewFieldMetaData = {
    ...
    size?: number;
    embedded?: boolean;
    embeddedViews?: DataBaseEntityViews;
    label?: string;
    showFields?: string[];
    superSelect?: string[];
    widthPreview?: string;
...
type DataBaseEntityViewOptions = {
    labels?: any;    
    permissions?: any;    
}
type DataBaseEntityViewFieldsOptions = {
    _?: DataBaseEntityViewOptions;
}   
type DataBaseEntityViewFields = {
    [name: string]: DataBaseEntityViewFieldMetaData;
}    
type DataBaseEntityViews = {
    filterLayout?: DataBaseEntityViewFields | DataBaseEntityViewFieldsOptions
    tableLayout?: DataBaseEntityViewFields | DataBaseEntityViewFieldsOptions
    formLayout?: DataBaseEntityViewFields | DataBaseEntityViewFieldsOptions
    viewLayout?: DataBaseEntityViewFields | DataBaseEntityViewFieldsOptions
}
