...
export class AdminUserService {
    ...
    async findByfields(options: FindOneOptions<AdminUser>): Promise<AdminUser | undefined> {
        return await this.adminUserRepository.findOne(options);
    }

    async findAndCount(
        options: FindManyOptions<AdminUser>,
    ...
    async save(adminUser: AdminUser): Promise<AdminUser | undefined> {
        const element = await this.adminUserRepository.save(adminUser);
        return element;
    }

    async update(adminUser: AdminUser): Promise<AdminUser | undefined> {
        const element = await this.adminUserRepository.save(adminUser);
        return element;
    }

    async delete(adminUser: AdminUser): Promise<AdminUser | undefined> {
        const element = await this.adminUserRepository.remove(adminUser);
        return element;
    }
}
