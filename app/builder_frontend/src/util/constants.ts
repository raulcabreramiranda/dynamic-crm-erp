export const BASE_IMG_PATH = process.env.NEXT_PUBLIC_BASE_IMG_PATH || 'http://local.node.server:8082/'
export const BASE_API_VERSION_PATH = 'http://local.node.server:8082/'
