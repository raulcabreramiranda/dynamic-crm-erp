                                            ...
                                            <TableBodyCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    {hasAnyAuthority(null, ['adminPermission'], 'view') ? (
                                                        <Button color="primary" size="small" onClick={() => openViewModal(adminPermission)} icon={'eye'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['adminPermission'], 'edit') ? (
                                                        <Button color="primary" size="small" onClick={() => openUpdateModal(adminPermission)} icon={'pencil'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['adminPermission'], 'canDelete') ? (
                                                        <Button color="primary" size="small" onClick={() => deleteEntityModal(adminPermission)} icon={'trash'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}{' '}
                                                </div>
