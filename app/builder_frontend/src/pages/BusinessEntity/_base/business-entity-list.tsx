                                            ...
                                            <TableBodyCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    {hasAnyAuthority(null, ['businessEntity'], 'view') ? (
                                                        <Button color="primary" size="small" onClick={() => openViewModal(businessEntity)} icon={'eye'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['businessEntity'], 'edit') ? (
                                                        <Button color="primary" size="small" onClick={() => openUpdateModal(businessEntity)} icon={'pencil'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['businessEntity'], 'canDelete') ? (
                                                        <Button color="primary" size="small" onClick={() => deleteEntityModal(businessEntity)} icon={'trash'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}{' '}
                                                </div>
