                                            ...
                                            <TableBodyCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    {hasAnyAuthority(null, ['photo'], 'view') ? (
                                                        <Button color="primary" size="small" onClick={() => openViewModal(photo)} icon={'eye'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['photo'], 'edit') ? (
                                                        <Button color="primary" size="small" onClick={() => openUpdateModal(photo)} icon={'pencil'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}
                                                    {hasAnyAuthority(null, ['photo'], 'canDelete') ? (
                                                        <Button color="primary" size="small" onClick={() => deleteEntityModal(photo)} icon={'trash'}></Button>
                                                    ) : (
                                                        <></>
                                                    )}{' '}
                                                </div>
