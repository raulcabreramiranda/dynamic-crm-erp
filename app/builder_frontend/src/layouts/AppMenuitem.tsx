...
const AppMenuitem = (props: { item: any; className?: string; parentKey?: React.SetStateAction<string>; index: string; root?: any; }) => {
    ...
    const itemClick = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
        ...
        // toggle active state
        if (item.items)
            setActiveMenu(active && props.parentKey ? props.parentKey : key);
        else
            setActiveMenu(key);
    };
