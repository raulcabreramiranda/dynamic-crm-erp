...
// @ts-ignore
const Nav = (await import('mfe_service/nav')).default;
// @ts-ignore
const add = (await import('mfe_service/add')).default;
// @ts-ignore
const multiplyByTwo = (await import('mfe_service/multiplyByTwo')).default;
