...
import { apiGetList, apiGetEntityForm, apiGetEntityView, apiDeleteEntity } from 'src/components/services/AdminPermission/admin-permission-services';

import { IAdminPermission } from 'src/components/models/AdminPermission/admin-permission-model';

import EntityContext from 'src/components/contexts/AdminPermission/admin-permission-context';
                                        ...
                                        <TableBodyRow tableRowIndex={i} key={`entity-${i}`}>
                                            ...
                                            <TableBodyCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    <Button color="success" size="small" onClick={() => openViewModal(adminPermission)} isLink={false} icon={'eye'}></Button>

                                                    <Button color="primary" size="small" onClick={() => openUpdateModal(adminPermission)} isLink={false} icon={'pencil'}></Button>

                                                    <Button color="danger" size="small" onClick={() => deleteEntityModal(adminPermission)} isLink={false} icon={'trash'}></Button>
                                                </div>
                                            </TableBodyCell>
                                        </TableBodyRow>
                                    ))}
