...
import { apiGetList, apiGetEntityForm, apiGetEntityView, apiUpdateEntity, apiNewEntity, apiDeleteEntity } from 'src/components/services/AdminWhiteLabel/admin-white-label-services';

import { IAdminWhiteLabel, IAdminWhiteLabelFilters } from 'src/components/models/AdminWhiteLabel/admin-white-label-model';
import FormView from 'src/components/views/AdminWhiteLabel/admin-white-label-view';
import FormUpdate from 'src/components/views/AdminWhiteLabel/admin-white-label-form';
import ListTable, { IEntityListSort } from 'src/components/views/AdminWhiteLabel/admin-white-label-list';
import FilterList from 'src/components/views/AdminWhiteLabel/admin-white-label-filter';

import EntityContext, { IReloadList } from 'src/components/contexts/AdminWhiteLabel/admin-white-label-context';
...
function ModalView() {
    ...
    return (
        <Dialog isOpen={true} onClose={handleClose}>
            <DialogTitle onClose={handleClose}>Detalhe do WhiteLabel</DialogTitle>
            <DialogContent>
                <FormView />
            </DialogContent>
            <DialogActions>
...
function ModalUpdate() {
    ...
    return (
        <Dialog isOpen={true} onClose={handleClose}>
            <DialogTitle onClose={handleClose}>{!!entityEdit.id && entityEdit?.id > 0 ? 'Atualizar WhiteLabel' : 'Criar WhiteLabel'}</DialogTitle>
            <DialogContent>
