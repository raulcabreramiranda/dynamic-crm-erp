...
import { apiGetList, apiGetEntityForm, apiGetEntityView, apiUpdateEntity, apiNewEntity, apiDeleteEntity } from 'src/components/services/Customer/customer-services';

import { ICustomer, ICustomerFilters } from 'src/components/models/Customer/customer-model';
import FormView from 'src/components/views/Customer/customer-view';
import FormUpdate from 'src/components/views/Customer/customer-form';
import ListTable, { IEntityListSort } from 'src/components/views/Customer/customer-list';
import FilterList from 'src/components/views/Customer/customer-filter';

import EntityContext, { IReloadList } from 'src/components/contexts/Customer/customer-context';
