import { PatientSex } from 'src/components/enumerations/patient-sex.model';
import { PatientLiminar } from 'src/components/enumerations/patient-liminar.model';
import { PatientStatus } from 'src/components/enumerations/patient-status.model';
import { PatientAdId } from 'src/components/enumerations/patient-ad-id.model';
import { PatientPatientComplexity } from 'src/components/enumerations/patient-patient-complexity.model';
import { PatientObese } from 'src/components/enumerations/patient-obese.model';
...
export interface IPatientFilters extends IPatientFilter {
    baseFilters?: string;
    extraFilters?: string;
    activePage?: number;
    itemsPerPage?: number;
