                                            ...
                                            <TableCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    {hasAnyAuthority(null, ['adminProfile'], 'view') ? (
                                                        <IconButton color="primary" size="small" onClick={() => openViewModal(adminProfile)}>
                                                    ...
                                                    {hasAnyAuthority(null, ['adminProfile'], 'edit') ? (
                                                        <IconButton color="primary" size="small" onClick={() => openUpdateModal(adminProfile)}>
                                                    ...
                                                    {hasAnyAuthority(null, ['adminProfile'], 'canDelete') ? (
                                                        <IconButton color="primary" size="small" onClick={() => deleteEntityModal(adminProfile)}>
