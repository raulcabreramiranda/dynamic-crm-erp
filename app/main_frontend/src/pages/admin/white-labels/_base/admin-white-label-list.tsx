                                            ...
                                            <TableCell align={'right'}>
                                                <div className="btn-group flex-btn-group-container">
                                                    {hasAnyAuthority(null, ['adminWhiteLabel'], 'view') ? (
                                                        <IconButton color="primary" size="small" onClick={() => openViewModal(adminWhiteLabel)}>
                                                    ...
                                                    {hasAnyAuthority(null, ['adminWhiteLabel'], 'edit') ? (
                                                        <IconButton color="primary" size="small" onClick={() => openUpdateModal(adminWhiteLabel)}>
                                                    ...
                                                    {hasAnyAuthority(null, ['adminWhiteLabel'], 'canDelete') ? (
                                                        <IconButton color="primary" size="small" onClick={() => deleteEntityModal(adminWhiteLabel)}>
